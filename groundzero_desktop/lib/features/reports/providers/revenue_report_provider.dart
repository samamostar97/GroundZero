...
class RevenueReportNotifier extends Notifier<RevenueReportState> {
  ...
  Future<void> exportReport(String format, BuildContext context) async {
    ...
    final path = await FilePicker.platform.saveFile(
      ...
      fileName: 'izvjestaj-prihodi.$ext',
    ...
    try {
      final bytes = await _repository.downloadReport(
        endpoint: ApiConstants.revenueReport,
        from: state.from,
        to: state.to,
