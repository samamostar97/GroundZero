...
class ApiException implements Exception {
  ...
  factory ApiException.fromDioException(DioException e) {
    ...
    if (response != null && response.data is Map<String, dynamic>) {
      ...
      return ApiException(
        ...
        errors:
            errors.isEmpty ? [_defaultMessage(response.statusCode)] : errors,
      );
    }
    ...
    if (e.type == DioExceptionType.connectionError) {
      return ApiException(
        statusCode: 0,
        errors: ['Nema konekcije sa serverom. Provjerite da li je API pokrenut.'],
      );
    }
  ...
  String get firstError =>
      errors.isNotEmpty ? errors.first : 'Nepoznata greška.';
