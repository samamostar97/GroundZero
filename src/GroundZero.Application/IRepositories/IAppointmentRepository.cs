...
public interface IAppointmentRepository : IRepository<Appointment>
{
    ...
    Task<PagedResult<Appointment>> GetAllAppointmentsPagedAsync(string? search, AppointmentStatus? status, int? staffId, int? userId, string? sortBy, bool sortDescending, int pageNumber, int pageSize, string? excludeStatuses = null, CancellationToken cancellationToken = default);
