...
public interface IOrderRepository : IRepository<Order>
{
    ...
    Task<PagedResult<Order>> GetAllOrdersPagedAsync(string? search, OrderStatus? status, int? userId, string? sortBy, bool sortDescending, int pageNumber, int pageSize, CancellationToken cancellationToken = default);
}
