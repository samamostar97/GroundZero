...
public interface IUserRepository : IRepository<User>
{
    ...
    Task<PagedResult<User>> GetPagedAsync(string? search, string? sortBy, bool sortDescending, int pageNumber, int pageSize, bool? hasActiveMembership = null, CancellationToken cancellationToken = default);
