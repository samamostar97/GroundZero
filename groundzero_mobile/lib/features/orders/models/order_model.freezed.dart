...
class _$OrderModelImpl implements _OrderModel {
  ...
  @override
  String toString() {
    return 'OrderModel(id: $id, userId: $userId, userFullName: $userFullName, totalAmount: $totalAmount, status: $status, stripePaymentIntentId: $stripePaymentIntentId, stripeClientSecret: $stripeClientSecret, items: $items, createdAt: $createdAt)';
  }
